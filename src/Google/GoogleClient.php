...
use Google\Cache\CacheFile;
use Google\Cache\Memcache;
...
class GoogleClient
{
   ...
   * @param ClientInterface $authHttp an http client for authentication.
   * @return void
   */
  ...
  {
    return AuthHandlerFactory::build($this->getCache());
  }
