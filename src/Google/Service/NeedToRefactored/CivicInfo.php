...
class Google_Service_CivicInfo_AdministrationRegion extends GoogleCollection
{
...
class Google_Service_CivicInfo_AdministrativeBody extends GoogleCollection
{
...
class Google_Service_CivicInfo_Candidate extends GoogleCollection
{
...
class Google_Service_CivicInfo_Contest extends GoogleCollection
{
  protected $collection_key = 'sources';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_CivicInfo_DivisionSearchResponse extends GoogleCollection
{
...
class Google_Service_CivicInfo_DivisionSearchResult extends GoogleCollection
{
...
class Google_Service_CivicInfo_ElectionsQueryResponse extends GoogleCollection
{
...
class Google_Service_CivicInfo_GeographicDivision extends GoogleCollection
{
...
class Google_Service_CivicInfo_Office extends GoogleCollection
{
  protected $collection_key = 'sources';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_CivicInfo_Official extends GoogleCollection
{
...
class Google_Service_CivicInfo_PollingLocation extends GoogleCollection
{
  protected $collection_key = 'sources';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_CivicInfo_RepresentativeInfoData extends GoogleCollection
{
...
class Google_Service_CivicInfo_RepresentativeInfoResponse extends GoogleCollection
{
  protected $collection_key = 'officials';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_CivicInfo_VoterInfoResponse extends GoogleCollection
{
