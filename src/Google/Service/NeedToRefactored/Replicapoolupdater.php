...
class Google_Service_Replicapoolupdater_InstanceUpdateError extends GoogleCollection
{
...
class Google_Service_Replicapoolupdater_InstanceUpdateList extends GoogleCollection
{
...
class Google_Service_Replicapoolupdater_Operation extends GoogleCollection
{
...
class Google_Service_Replicapoolupdater_OperationError extends GoogleCollection
{
  protected $collection_key = 'errors';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_Replicapoolupdater_OperationList extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_Replicapoolupdater_OperationWarnings extends GoogleCollection
{
...
class Google_Service_Replicapoolupdater_RollingUpdateError extends GoogleCollection
{
  protected $collection_key = 'errors';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_Replicapoolupdater_RollingUpdateList extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
