...
class Google_Service_Cloudtrace_ListTracesResponse extends GoogleCollection
{
...
class Google_Service_Cloudtrace_Trace extends GoogleCollection
{
...
class Google_Service_Cloudtrace_Traces extends GoogleCollection
{
  protected $collection_key = 'traces';
  protected $internal_gapi_mappings = array(
  );
