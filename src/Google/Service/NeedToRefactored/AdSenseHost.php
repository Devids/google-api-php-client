...
class Google_Service_AdSenseHost_Accounts extends GoogleCollection
{
...
class Google_Service_AdSenseHost_AdClients extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_AdSenseHost_AdUnits extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_AdSenseHost_AssociationSession extends GoogleCollection
{
...
class Google_Service_AdSenseHost_CustomChannels extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_AdSenseHost_Report extends GoogleCollection
{
...
class Google_Service_AdSenseHost_UrlChannels extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
