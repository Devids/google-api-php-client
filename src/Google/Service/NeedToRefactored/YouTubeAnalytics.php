...
class Google_Service_YouTubeAnalytics_BatchReport extends GoogleCollection
{
...
class Google_Service_YouTubeAnalytics_BatchReportDefinitionList extends GoogleCollection
{
...
class Google_Service_YouTubeAnalytics_BatchReportList extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_YouTubeAnalytics_GroupItemListResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_YouTubeAnalytics_GroupListResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_YouTubeAnalytics_ResultTable extends GoogleCollection
{
