...
class Google_Service_Tasks_Task extends GoogleCollection
{
...
class Google_Service_Tasks_TaskLists extends GoogleCollection
{
...
class Google_Service_Tasks_Tasks extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
