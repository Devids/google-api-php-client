...
class Google_Service_GamesConfiguration_AchievementConfigurationListResponse extends GoogleCollection
{
...
class Google_Service_GamesConfiguration_LeaderboardConfigurationListResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_GamesConfiguration_LocalizedStringBundle extends GoogleCollection
{
