...
class Google_Service_IdentityToolkit_DownloadAccountResponse extends GoogleCollection
{
...
class Google_Service_IdentityToolkit_GetAccountInfoResponse extends GoogleCollection
{
  protected $collection_key = 'users';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_IdentityToolkit_IdentitytoolkitRelyingpartyGetAccountInfoRequest extends GoogleCollection
{
...
class Google_Service_IdentityToolkit_IdentitytoolkitRelyingpartySetAccountInfoRequest extends GoogleCollection
{
...
class Google_Service_IdentityToolkit_IdentitytoolkitRelyingpartyUploadAccountRequest extends GoogleCollection
{
  protected $collection_key = 'users';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_IdentityToolkit_SetAccountInfoResponse extends GoogleCollection
{
...
class Google_Service_IdentityToolkit_UploadAccountResponse extends GoogleCollection
{
...
class Google_Service_IdentityToolkit_UserInfo extends GoogleCollection
{
  protected $collection_key = 'providerUserInfo';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_IdentityToolkit_VerifyAssertionResponse extends GoogleCollection
{
