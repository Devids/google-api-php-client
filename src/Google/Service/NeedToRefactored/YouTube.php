...
class Google_Service_YouTube_AccessPolicy extends GoogleCollection
{
...
class Google_Service_YouTube_ActivityContentDetailsPromotedItem extends GoogleCollection
{
...
class Google_Service_YouTube_ActivityListResponse extends GoogleCollection
{
...
class Google_Service_YouTube_CaptionListResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_YouTube_ChannelBrandingSettings extends GoogleCollection
{
...
class Google_Service_YouTube_ChannelConversionPings extends GoogleCollection
{
...
class Google_Service_YouTube_ChannelListResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_YouTube_ChannelSectionContentDetails extends GoogleCollection
{
...
class Google_Service_YouTube_ChannelSectionListResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_YouTube_ChannelSectionTargeting extends GoogleCollection
{
...
class Google_Service_YouTube_ChannelSettings extends GoogleCollection
{
...
class Google_Service_YouTube_ChannelTopicDetails extends GoogleCollection
{
...
class Google_Service_YouTube_CommentListResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_YouTube_CommentThreadListResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_YouTube_CommentThreadReplies extends GoogleCollection
{
...
class Google_Service_YouTube_ContentRating extends GoogleCollection
{
...
class Google_Service_YouTube_GuideCategoryListResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_YouTube_I18nLanguageListResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_YouTube_I18nRegionListResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_YouTube_InvideoPromotion extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_YouTube_LiveBroadcastListResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_YouTube_LiveBroadcastTopicDetails extends GoogleCollection
{
...
class Google_Service_YouTube_LiveStreamHealthStatus extends GoogleCollection
{
...
class Google_Service_YouTube_LiveStreamListResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_YouTube_LocalizedProperty extends GoogleCollection
{
...
class Google_Service_YouTube_PlaylistItemListResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_YouTube_PlaylistListResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_YouTube_PlaylistSnippet extends GoogleCollection
{
...
class Google_Service_YouTube_SearchListResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_YouTube_SubscriptionListResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_YouTube_ThumbnailSetResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_YouTube_VideoAbuseReportReasonListResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_YouTube_VideoAbuseReportReasonSnippet extends GoogleCollection
{
...
class Google_Service_YouTube_VideoCategoryListResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_YouTube_VideoContentDetailsRegionRestriction extends GoogleCollection
{
...
class Google_Service_YouTube_VideoConversionPings extends GoogleCollection
{
  protected $collection_key = 'pings';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_YouTube_VideoFileDetails extends GoogleCollection
{
...
class Google_Service_YouTube_VideoGetRatingResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_YouTube_VideoListResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_YouTube_VideoProjectDetails extends GoogleCollection
{
  protected $collection_key = 'tags';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_YouTube_VideoSnippet extends GoogleCollection
{
  protected $collection_key = 'tags';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_YouTube_VideoSuggestions extends GoogleCollection
{
...
class Google_Service_YouTube_VideoSuggestionsTagSuggestion extends GoogleCollection
{
...
class Google_Service_YouTube_VideoTopicDetails extends GoogleCollection
{
  protected $collection_key = 'topicIds';
  protected $internal_gapi_mappings = array(
  );
