...
class Google_Service_Taskqueue_TaskQueueAcl extends GoogleCollection
{
...
class Google_Service_Taskqueue_Tasks extends GoogleCollection
{
...
class Google_Service_Taskqueue_Tasks2 extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
