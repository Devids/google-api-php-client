...
class Google_Service_Games_AchievementDefinitionsListResponse extends GoogleCollection
{
...
class Google_Service_Games_AchievementUpdateMultipleRequest extends GoogleCollection
{
...
class Google_Service_Games_AchievementUpdateMultipleResponse extends GoogleCollection
{
...
class Google_Service_Games_Application extends GoogleCollection
{
...
class Google_Service_Games_CategoryListResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_Games_EventDefinition extends GoogleCollection
{
...
class Google_Service_Games_EventDefinitionListResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_Games_EventPeriodUpdate extends GoogleCollection
{
  protected $collection_key = 'updates';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_Games_EventRecordRequest extends GoogleCollection
{
...
class Google_Service_Games_EventUpdateResponse extends GoogleCollection
{
...
class Google_Service_Games_LeaderboardListResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_Games_LeaderboardScores extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_Games_MetagameConfig extends GoogleCollection
{
...
class Google_Service_Games_PlayerAchievementListResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_Games_PlayerEventListResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_Games_PlayerLeaderboardScoreListResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_Games_PlayerListResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_Games_PlayerScoreListResponse extends GoogleCollection
{
...
class Google_Service_Games_PlayerScoreResponse extends GoogleCollection
{
...
class Google_Service_Games_PlayerScoreSubmissionList extends GoogleCollection
{
...
class Google_Service_Games_Quest extends GoogleCollection
{
...
class Google_Service_Games_QuestListResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_Games_QuestMilestone extends GoogleCollection
{
...
class Google_Service_Games_Room extends GoogleCollection
{
...
class Google_Service_Games_RoomCreateRequest extends GoogleCollection
{
...
class Google_Service_Games_RoomJoinRequest extends GoogleCollection
{
...
class Google_Service_Games_RoomLeaveDiagnostics extends GoogleCollection
{
...
class Google_Service_Games_RoomList extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_Games_RoomP2PStatuses extends GoogleCollection
{
  protected $collection_key = 'updates';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_Games_RoomParticipant extends GoogleCollection
{
  protected $collection_key = 'capabilities';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_Games_RoomStatus extends GoogleCollection
{
  protected $collection_key = 'participants';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_Games_SnapshotListResponse extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_Games_TurnBasedMatch extends GoogleCollection
{
...
class Google_Service_Games_TurnBasedMatchCreateRequest extends GoogleCollection
{
  protected $collection_key = 'invitedPlayerIds';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_Games_TurnBasedMatchList extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_Games_TurnBasedMatchResults extends GoogleCollection
{
  protected $collection_key = 'results';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_Games_TurnBasedMatchSync extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_Games_TurnBasedMatchTurn extends GoogleCollection
{
  protected $collection_key = 'results';
  protected $internal_gapi_mappings = array(
  );
