...
class Google_Service_PlusDomains_Acl extends GoogleCollection
{
...
class Google_Service_PlusDomains_ActivityFeed extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_PlusDomains_ActivityObject extends GoogleCollection
{
...
class Google_Service_PlusDomains_ActivityObjectAttachments extends GoogleCollection
{
...
class Google_Service_PlusDomains_AudiencesFeed extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_PlusDomains_CircleFeed extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_PlusDomains_Comment extends GoogleCollection
{
...
class Google_Service_PlusDomains_CommentFeed extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_PlusDomains_Media extends GoogleCollection
{
...
class Google_Service_PlusDomains_PeopleFeed extends GoogleCollection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Google_Service_PlusDomains_Person extends GoogleCollection
{
